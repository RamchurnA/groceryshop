...
export default function ProductListScreen() {
    ...
    const deleteHandler = async (product) => {
        ...
        if (window.confirm('Are you sure you want to delete the product')) {
            ...
            try {
                await axios.delete(`/api/products/pid/${product._id}`, {
                    headers: { Authorization: `Bearer ${userInfo.token}` }
                });
    ...
    <div>
        ...
        {loading ? (
            ...
            <>
                ...
                <div>
                    {[...Array(pages).keys()].map((x) => ( // returns an array from 0 to pages - 1 and use map function to convert it to a link [1,2,pages-1]
                        <Link
